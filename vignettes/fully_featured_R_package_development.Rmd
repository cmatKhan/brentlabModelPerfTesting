...
vignette: >
  %\VignetteIndexEntry{fully_featured_R_package_development}
...
`dev` may, on the otherhand, be unstable as you develop. 
  ...
  at which you bump the [semantic versioning]() (you may choose to do this 
...
First, if you aren't writing tests along with your code, and especially if you 
have any preconceived notions about what tests are, then get rid of them. 
...
#'   suppressWarnings({prepped_data_subset = brentlabXGBoost::prep_data(test_data, 10)})
#'
